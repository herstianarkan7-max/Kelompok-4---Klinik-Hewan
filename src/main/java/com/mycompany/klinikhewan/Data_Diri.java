 ...
 * @author LENOVO
 */
public class Data_Diri extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Data_Diri.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Data_Diri().setVisible(true));
    }
