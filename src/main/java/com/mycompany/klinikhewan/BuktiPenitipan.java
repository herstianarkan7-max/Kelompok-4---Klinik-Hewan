 ...
 * @author Nafisah
 */
public class BuktiPenitipan extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(BuktiPenitipan.class.getName());
int idPenitipanMasuk;

public void tangkapIdPenitipan(int id) {
    this.idPenitipanMasuk = id;
    
    // Panggil fungsi untuk menampilkan data di textfield bukti pendaftaran
    muatDataBukti(); 
}
    /**
     * Creates new form BuktiPenitipan
     */
    public BuktiPenitipan() {
        initComponents();
    }
public void muatDataBukti() {
    try {
        ...
        if (rs.next()) {
            ...
            txtNomorKandang.setText(rs.getString("nomor_kandang"));
        }
    } catch (Exception e) {
        System.out.println("Error bukti: " + e.getMessage());
    }
}
    /**
    ...
    private void initComponents() {
        ...
        txtNomorKandang = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setFont(new java.awt.Font("Bookman Old Style", 1, 24)); // NOI18N
        jLabel1.setText("BUKTI PENITIPAN");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtNamaHewan, javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jLabel3)
                        .addComponent(txtTanggalMasuk)
                        .addComponent(txtTanggalKeluar)
                        .addComponent(txtNomorKandang)))
                .addGap(80, 80, 80))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtNomorKandang, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jButton1)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NotaBayarPenitipan nbp = new NotaBayarPenitipan();
    
    // Oper ID transaksi penitipan ke form nota bayar akhir
    nbp.tangkapIdPenitipan(this.idPenitipanMasuk); 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new BuktiPenitipan().setVisible(true));
    }
    ...
    private javax.swing.JTextField txtNomorKandang;
