    ...
    public void muatDataNota(int idPeriksa) {
        try {
            ...
            if (rs.next()) {
                ...
                int tarif = 0;
                if (dokter.contains("Andi")) {
                    tarif = 100000;
                } else if (dokter.contains("Siska")) {
                    tarif = 150000;
                } else {
            ...
            JOptionPane.showMessageDialog(null, "Gagal muat data nota pemeriksaan: " + e.getMessage());
        }
    }
    /**
